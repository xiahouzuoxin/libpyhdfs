...
pyhdfs = Extension('pyhdfs',
        ...
        runtime_library_dirs=[
            ...
            find_directory_containing((
                ...
                '/usr/lib64',
                '/etc',
                os.path.join(hadoop_home,'/lib/native')
                ),
                'libhdfs.so'),
            ],
        )
...
setup(name='python-hdfs',
        ...
        maintainer="hzxiahouzuoxin",
        description="Python3 wrapper for libhdfs",
        long_description=(open('README').read()),
        url="https://github.com/hzxiahouzuoxin/pylibhdfs",
